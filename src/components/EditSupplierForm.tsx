...
interface EditSupplierFormProps {
  ...
  onSubmit: (values: Partial<Supplier>) => Promise<void>;
  onFinished: () => void;
}
export function EditSupplierForm({ initialValues, onSubmit, onFinished }: EditSupplierFormProps) {
  ...
  const form = useForm<SupplierFormValues>({
    ...
    defaultValues: {
      ...
      constructionStages: initialValues.constructionStages || [],
      supplyReach: initialValues.supplyReach,
      supplyRadiusKm: initialValues.supplyRadiusKm,
    },
  });
